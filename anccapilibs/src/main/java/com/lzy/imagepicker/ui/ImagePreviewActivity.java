...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTitleCount.setText(getString(R.string.album_ip_preview_image_count, mCurrentPosition + 1,
			  mImageItems.size()));
		...
		mViewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				boolean isSelected = imagePicker.isSelect(item);
				mCbCheck.setChecked(isSelected);
				mTitleCount.setText(getString(R.string.album_ip_preview_image_count,
		...
		mCbCheck.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
					Toast.makeText(ImagePreviewActivity.this, getString(R.string.album_ip_select_limit
	...
	public void onImageSelected(int position, ImageItem item, boolean isAdd) {
		...
		if (mCbOrigin.isChecked()) {
			...
			mCbOrigin.setText(getString(R.string.album_ip_origin_size, fileSize));
		}
	}
	...
	public void onImageSingleTap() {
		if (topBar.getVisibility() == View.VISIBLE) {
			...
			//            if (Build.VERSION.SDK_INT >= 16) content.setSystemUiVisibility(View

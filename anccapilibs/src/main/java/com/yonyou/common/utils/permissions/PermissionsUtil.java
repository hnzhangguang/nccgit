package com.yonyou.common.utils.permissions;
...
public class PermissionsUtil {
	...
	public static class TipInfo implements Serializable {
		...
		public TipInfo(@Nullable String title, @Nullable String content, @Nullable String cancel,
		               @Nullable String ensure) {
			this.title = title;

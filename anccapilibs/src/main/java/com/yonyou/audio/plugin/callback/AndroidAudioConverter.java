...
public class AndroidAudioConverter {
    ...
    private PersonalAudioFormat format;
...
//                    });
    ...
    private static File getConvertedFile(File originalFile, PersonalAudioFormat format) {
    ...
    public AndroidAudioConverter setFormat(PersonalAudioFormat format) {
        this.format = format;
        return this;
    }

...
public class UMGZipUtil {
	 ...
	 * @throws Exception
	 */
	public static byte[] compressedDataWithData(byte[] data) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static byte[] dataWithCompressedData(byte[] data) throws Exception {
		ByteArrayInputStream bais = new ByteArrayInputStream(data);
		ByteArrayOutputStream baos = new ByteArrayOutputStream();

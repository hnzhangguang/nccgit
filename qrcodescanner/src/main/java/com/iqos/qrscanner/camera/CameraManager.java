...
public final class CameraManager {
    static final int SDK_INT = Build.VERSION.SDK_INT;//SDK版本
...
//            }
    ...
    /**
     * 绘制取景框(固定了高宽、都是2/3屏幕宽度)
     *
     * @return 矩形取景框
     */
    public Rect getFramingRect() {
        Point screenResolution = configManager.getScreenResolution();
        if (screenResolution.y > 1500) {
            screenResolution.y = screenResolution.y / 2;
        }
        ...
        if (null == framingRect) {
            ...
            framingRect = new Rect(leftOffset, topOffset / 2, leftOffset + width, (topOffset + height) * 2 / 3);
        }
        return framingRect;
    }

...
public class TabView extends FrameLayout {
	...
	private static int COLOR_SELECT = Color.parseColor("#F64D33");
	...
	public TabView(@NonNull Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		COLOR_DEFAULT = getResources().getColor(R.color.sys_tab_text);
		COLOR_SELECT = getResources().getColor(R.color.sys_tab_text_select);

...
public class AppManagerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
	...
	private List<AppInfoVo> mMyChannelItems, mOtherChannelItems;
	
	// 我的频道点击事件
	private OnMyChannelItemClickListener mChannelItemClickListener;
	private Handler delayHandler = new Handler();
	
	public AppManagerAdapter(Context context, ItemTouchHelper helper, List<AppInfoVo> mMyChannelItems
		  , List<AppInfoVo> mOtherChannelItems) {
	...
	private void moveMyToOther(MyViewHolder myHolder) {
		...
		AppInfoVo item = mMyChannelItems.get(startPosition);
	...
	private int processItemRemoveAdd(OtherViewHolder otherHolder) {
		...
		AppInfoVo item = mOtherChannelItems.get(startPosition);
	...
	public void onItemMove(int fromPosition, int toPosition) {
		AppInfoVo item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);

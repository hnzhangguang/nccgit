 ...
 * @Author zhangg
 **/
public class NCCSimpleScanActivity extends BaseActivity implements QRCodeView.Delegate {
	...
	private static final String TAG = NCCWebViewScanActivity.class.getSimpleName();
	...
	private TextView openAblum;
	
	public NCCSimpleScanActivity() {
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.activity_ncc_simple_scan);
		...
		this.singleThreadPool.execute(new Runnable() {
			public void run() {
				try {
					...
					NCCSimpleScanActivity.this.runOnUiThread(new Runnable() {
						public void run() {
							NCCSimpleScanActivity.this.mZBarView.startSpot();
						}
					});
